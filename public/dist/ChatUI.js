...
export class ChatUI {
    ...
    initEventListeners() {
        ...
        if (regForm) {
            ...
            regDv === null || regDv === void 0 ? void 0 : regDv.classList.add('d-none');
            const regClick = document.getElementById('registerClick');
            regClick === null || regClick === void 0 ? void 0 : regClick.addEventListener('click', () => {
                regDv === null || regDv === void 0 ? void 0 : regDv.classList.remove('d-none');
                logDiv === null || logDiv === void 0 ? void 0 : logDiv.classList.add('d-none');
            });
        }
        // 2) Login
        ...
        if (loginForm) {
            ...
            logClick === null || logClick === void 0 ? void 0 : logClick.addEventListener('click', () => {
                logDiv === null || logDiv === void 0 ? void 0 : logDiv.classList.remove('d-none');
                regDv === null || regDv === void 0 ? void 0 : regDv.classList.add('d-none');
            });
        }
        // 3) Get Users
        ...
        if (sendForm) {
            ...
            chatDiv === null || chatDiv === void 0 ? void 0 : chatDiv.classList.add('d-none');
        }
    }
    // --------------------------------------------------------------------------
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (response.token) {
                    ...
                    const chatDiv = document.getElementById('chatDiv');
                    chatDiv === null || chatDiv === void 0 ? void 0 : chatDiv.classList.remove('d-none');
                    const logDiv = document.getElementById('logDiv');
                    logDiv === null || logDiv === void 0 ? void 0 : logDiv.classList.add('d-none');
                    if (loginResultDiv) {
    ...
    handleSendMessage(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield ApiService.sendMessage(this.selectedUserId, message);
                if (response.success) {
                    if (sendResultDiv) {
                        this.loadMessages();
    ...
    loadMessages() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.selectedUserId || !chatWindow)
                return;
            if (chatWindow)
                chatWindow.innerHTML = 'Loading messages...';
            const messages = yield ApiService.getConversation(this.selectedUserId);
                ...
                if (Array.isArray(messages)) {
                    if (chatWindow) {
                        ...
                        messages.forEach((msg) => {
                            ...
                            p.textContent = `${msg.sender_id === this.selectedUserId ? 'Them' : 'You'}: ${msg.message}`;
                    ...
                    if (chatWindow)
                        chatWindow.innerHTML = `Error: ${messages.error}`;
                }
            }
            catch (err) {
                console.error('selectUser Error:', err);
                if (chatWindow)
                    chatWindow.innerHTML = 'Error loading conversation.';
            }
        });
    }
}
